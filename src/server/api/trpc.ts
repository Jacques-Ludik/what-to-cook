...
import { getServerAuthSession } from "~/server/auth"; // We will use our wrapper here
...
export const createTRPCContext = async (opts: CreateNextContextOptions) => {
  // We get the req and res objects from the 'opts' parameter
  const { req, res } = opts;

  // Get the session from the server using the getServerSession wrapper.
  // The wrapper we created is smart enough to work here because next-auth's
  // getServerSession can read cookies from the 'req' object.
...
//   const session = await getServerAuthSession(); // Uses our new function
//   return {
//     session,
//     db,
//     ...opts,
